...
// New Routes
// app.use(`${API_VERSION}/users`, require('./routes/user.routes')); // Old: this was our setup before migrating to Cognito, where we still manually managed users with JWT and the Mongo database.
